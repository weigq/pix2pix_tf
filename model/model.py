...
def create_generator(generator_inputs, generator_outputs_channels, opt):
    layers = []
...
def create_model(inputs, targets, opt):
    ...
    with tf.variable_scope("generator") as scope:
        ...
        outputs = create_generator(inputs, out_channels, opt)
